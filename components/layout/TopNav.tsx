...
import { Bell, Search, ShieldCheck, Sun, Moon, Globe, User, Layers } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span>Border Protected</span>
          </div>

          {/* Language Selector Modal Trigger */}
          <button
            onClick={() => setShowLangModal(true)}
            className="btn-ghost text-xs px-2.5 py-1.5 hidden sm:inline-flex items-center gap-1.5 cursor-pointer"
            title="Switch language (17 languages available)"
          >
            <Globe className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
            <span className="font-bold font-mono">{currentLanguageInfo.code.toUpperCase()}</span>
          </button>
          ...
          <div className="relative">
            <button
              ...
              className="btn-ghost relative p-2 cursor-pointer"
